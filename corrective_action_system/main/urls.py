...
urlpatterns = [
    ...
    path('internal-auditor/guidelines/', views.internal_auditor_guidelines_view, name='internal_auditor_guidelines'),
    path('process-owner-forms/', views.process_owner_forms_view, name='process_owner_forms'),
    path('process-owner-guidelines/', views.process_owner_guidelines_view, name='process_owner_guidelines'),
